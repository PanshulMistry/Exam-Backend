...
public class TestSecurityConfiguration {
	...
	public SecurityFilterChain securityFilterchain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(
				auth -> auth.requestMatchers("/test/users/export/excel","/test/search","/test/getUsers","/test/getUserDetails/**","/test/update-user","/test/deleteUser","/test/getAllUsers","/test/resetPasswordMail/**","/test/reset-password","/test/login","/test/saveUser", "/test/save-bulk-users/**")
